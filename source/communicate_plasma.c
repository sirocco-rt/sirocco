  ...
  for (current_rank = 0; current_rank < np_mpi_global; current_rank++)
  {
    ...
    if (rank_global == current_rank)
    {
      ...
      for (n_plasma = n_start; n_plasma < n_stop; ++n_plasma)
      {
        ...
        MPI_Pack (&cell->derived.nscat_upper, 1, MPI_INT, comm_buffer, comm_buffer_size, &position, MPI_COMM_WORLD);
        MPI_Pack (&cell->derived.nscat_lower, 1, MPI_INT, comm_buffer, comm_buffer_size, &position, MPI_COMM_WORLD);
        ...
        MPI_Pack (&cell->derived.nrad_upper, 1, MPI_INT, comm_buffer, comm_buffer_size, &position, MPI_COMM_WORLD);
        MPI_Pack (&cell->derived.nrad_lower, 1, MPI_INT, comm_buffer, comm_buffer_size, &position, MPI_COMM_WORLD);
    ...
    if (rank_global != current_rank)
    {
      ...
      for (i = 0; i < num_comm; i++)
      {
        ...
        MPI_Unpack (comm_buffer, comm_buffer_size, &position, &cell->derived.nscat_upper, 1, MPI_INT, MPI_COMM_WORLD);
        MPI_Unpack (comm_buffer, comm_buffer_size, &position, &cell->derived.nscat_lower, 1, MPI_INT, MPI_COMM_WORLD);
        ...
        MPI_Unpack (comm_buffer, comm_buffer_size, &position, &cell->derived.nrad_upper, 1, MPI_INT, MPI_COMM_WORLD);
        MPI_Unpack (comm_buffer, comm_buffer_size, &position, &cell->derived.nrad_lower, 1, MPI_INT, MPI_COMM_WORLD);
  ...
  for (n_mpi = 0; n_mpi < np_mpi_global; n_mpi++)
  {
    ...
    if (rank_global == n_mpi)
    {
      ...
      for (n_plasma = n_start_rank; n_plasma < n_stop_rank; n_plasma++)
      {
        ...
        MPI_Pack (&plasmamain[n_plasma].derived.nscat_upper, 1, MPI_INT, comm_buffer, size_of_comm_buffer, &position, MPI_COMM_WORLD);
        MPI_Pack (&plasmamain[n_plasma].derived.nscat_lower, 1, MPI_INT, comm_buffer, size_of_comm_buffer, &position, MPI_COMM_WORLD);
        ...
        MPI_Pack (&plasmamain[n_plasma].derived.nrad_upper, 1, MPI_INT, comm_buffer, size_of_comm_buffer, &position, MPI_COMM_WORLD);
        MPI_Pack (&plasmamain[n_plasma].derived.nrad_lower, 1, MPI_INT, comm_buffer, size_of_comm_buffer, &position, MPI_COMM_WORLD);
    ...
    if (rank_global != n_mpi)
    {
      ...
      for (i = 0; i < num_cells_communicated; ++i)
      {
        ...
        MPI_Unpack (comm_buffer, size_of_comm_buffer, &position, &plasmamain[n_plasma].derived.nscat_upper, 1, MPI_INT, MPI_COMM_WORLD);
        MPI_Unpack (comm_buffer, size_of_comm_buffer, &position, &plasmamain[n_plasma].derived.nscat_lower, 1, MPI_INT, MPI_COMM_WORLD);
        ...
        MPI_Unpack (comm_buffer, size_of_comm_buffer, &position, &plasmamain[n_plasma].derived.nrad_upper, 1, MPI_INT, MPI_COMM_WORLD);
        MPI_Unpack (comm_buffer, size_of_comm_buffer, &position, &plasmamain[n_plasma].derived.nrad_lower, 1, MPI_INT, MPI_COMM_WORLD);
