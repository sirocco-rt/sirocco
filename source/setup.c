...
init_ionization ()
{
  ...
  geo.ioniz_mode =
    rdchoice ("Wind.ionization(on.the.spot,ML93,LTE_tr,LTE_te,fixed,matrix_bb,matrix_pow,matrix_est,matrix_multishot,mastrix_boost)",
              "0,3,1,4,2,8,9,10,11,12", answer);
